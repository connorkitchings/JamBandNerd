      ...
      <div className="editorial-chip mx-auto flex max-w-md items-center justify-around rounded-[1.75rem] border border-outline-variant/30 bg-background/88 px-2 py-2 shadow-[0_20px_50px_rgba(0,0,0,0.35)]">
          ...
          return (
            <Link
              ...
              className={`flex min-w-16 flex-col items-center gap-1 rounded-2xl px-3 py-2 text-[10px] uppercase tracking-[0.12rem] transition ${
                isActive
            ...
            >
              <span className="font-headline text-lg leading-none" aria-hidden="true">{item.icon}</span>
