    ...
    <div className="mx-auto max-w-5xl space-y-8">
      ...
      <SectionCard title="How The Product Is Positioned">
        <div className="space-y-4 text-sm leading-6 text-on-surface-variant">
          ...
          <p>
            Predictions are generated by a per-band model that uses historical rotation
            patterns, gap behavior, and venue context to rank likely songs. The prediction
            approach was informed by the weighted-recency benchmark popularized by Phish.net.
          </p>
        </div>
      </SectionCard>
