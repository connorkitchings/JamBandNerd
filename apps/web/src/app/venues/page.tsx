          ...
          {snapshot ? (
            <>
              ...
              <SectionCard title="Top Songs At This Venue" eyebrow="Repeat history">
                <ResponsiveTableFrame minWidthClassName="min-w-[640px]" testId="venue-top-songs">
                  <thead>
              ...
              <DataState
                ...
                body={
                  state.selectionError && fallbackVenue
                    ...
                    : state.selectionError ?? "Choose a venue from the rail to load analytics."
                }
              />
            </SectionCard>
          )}
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <p className="mt-1 text-xs leading-5 text-on-surface-variant">
                            {buildLocationLabel([venue.city, venue.region]) || "Location unavailable"}
                          </p>
                        </div>
                        <div className="text-right">
                          <p className="font-headline text-base text-primary">{venue.showCount}</p>
